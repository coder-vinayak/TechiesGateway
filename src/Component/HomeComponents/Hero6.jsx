...
// const Testimonials = () => {
//   const [backgroundImage, setBackgroundImage] = useState('src/assets/Hero6.png');

//   // Function to handle resizing
//   const updateBackground = () => {
//     const width = window.innerWidth;
//     if (width < 480) {
//       setBackgroundImage('/path_to_small_mobile_image'); // For small mobile
//     } else if (width < 768) {
//       setBackgroundImage('/path_to_mobile_image'); // For mobile
//     } else {
//       setBackgroundImage('/path_to_default_image'); // Default image
//     }
//   };
...
//     window.addEventListener('resize', updateBackground); // Add resize listener
...
//     <div
//       id='Hero6image'
//       className="relative h-full w-full bg-gray-100 py-10 md:py-16"
//       style={{ backgroundImage: `url(${src/assets/Hero6.png})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
//     >
//       <div className='flex flex-col items-center gap-3'>
//         <div className='px-6 py-3 bg-indigo-50 w-fit flex gap-2 rounded-2xl text-indigo-600 font-medium text-lg'>
//           Testimonials
